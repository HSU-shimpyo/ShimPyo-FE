...
import { getWeeklyAverage, getWeeklyState } from '../api/SumHistory'
    ...
    <MainLayout>
      ...
      <WrapText>
        ...
        <StyledText fontSize="16px" fontWeight="400" lineHeight="24px" marginBottom="24px">
          이번 주의 쉼 상태는 <StyledText color={color} fontSize="24px" fontWeight="600" lineHeight="34px" letterSpacing="-0.6px">{maxState}</StyledText> 입니다.
        </StyledText>
      </WrapText>
